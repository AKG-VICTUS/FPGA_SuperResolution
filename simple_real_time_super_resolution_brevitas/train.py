...
if __name__ == '__main__':
    ...
    if args.wandb:
        run_log_wandb = wandb.init(entity="ajaykumargurrala", project='Realt_Time_Super_Resolution',
    ...
    if args.pretrain is not None:
        ...
        ckpt = torch.load(args.pretrain, map_location=device)
         # support both a full checkpoint dict and plain state_dict (or model_state_dict inside)
